    ...
    <div className="client-order-detail">
      ...
      <div className="client-order-detail__sidebar">
        <div className="client-order-detail__summary">
          <h2 className="client-order-detail__summary-title">
            Thông tin đơn hàng
          </h2>
        ...
        <div
          className="btn-rebuy client-order-detail__checkout"
          onClick={HandleOrder}
        >
          Đặt hàng
        </div>
      ...
      {formChangeAddress && (
        <ChangeAddressPage setFormChangeAddress={setFormChangeAddress} />
      )}
    </div>
  );
};
