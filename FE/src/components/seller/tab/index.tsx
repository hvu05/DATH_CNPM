    ...
    return (
        <>
            <div className='seller-tab-container'>
                <ul>
                    <li className={`${isActiveLink('seller') ? 'tab--active' : ''}`} onClick={() => navigate('/seller')}>
                        <span>
                    ...
                    <li className={`${isActiveLink('orders') ? 'tab--active' : ''}`} onClick={() => navigate('/seller/orders')}>
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <path d="M15 14.5C15 15.0523 15.4477 15.5 16 15.5C16.5523 15.5 17 15.0523 17 14.5H16H15ZM15.8746 10.5695L16.7493 10.0847L15.8746 10.5695ZM8 5.5L7.47 6.348L14.53 10.7605L15.06 9.9125L15.59 9.0645L8.53 4.652L8 5.5ZM16 14.5H17V11.6085H16H15V14.5H16ZM15.06 9.9125L14.53 10.7605C14.7757 10.9141 14.9004 10.9932 14.9843 11.0575C15.0512 11.1089 15.027 11.1029 15 11.0542L15.8746 10.5695L16.7493 10.0847C16.5969 9.80984 16.3951 9.61902 16.201 9.47022C16.0238 9.33438 15.8038 9.19813 15.59 9.0645L15.06 9.9125ZM16 11.6085H17C17 11.3564 17.0011 11.0976 16.9798 10.8753C16.9565 10.6319 16.9016 10.3596 16.7493 10.0847L15.8746 10.5695L15 11.0542C14.973 11.0056 14.9808 10.9818 14.9889 11.0659C14.9989 11.1711 15 11.3187 15 11.6085H16Z" fill="currentcolor" />
                            </svg>
                        </span>
                        <span>Quản lí đơn hàng</span>
                    </li>
                    <li onClick={() => navigate('/seller/status')} className={`${isActiveLink('status') ? 'tab--active' : ''}`}>
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
