...
export const createReviewHandler = async (
  req: Request,
  res: Response<ApiResponse<reviewDto.ReviewResponse>>,
  next: NextFunction,
) => {
...
export const getReviewsHandler = async (
  req: Request,
  res: Response<ApiResponse<reviewDto.ReviewListResponse>>,
  next: NextFunction,
) => {
  ...
  try {
    const reviews = await reviewService.getAllReviewsOfProduct(
      productId,
      query,
    );
    res.json({
