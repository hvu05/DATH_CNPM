  ...
  return (
    <div className="seller-status">
      ...
      <div className="seller-status__filter">
        <button
          className={`seller-status__filter-option ${
            filter == "all" ? "seller-status__filter-option--active" : ""
          }`}
        ...
        <button
          className={`seller-status__filter-option ${
            filter == "unupdate" ? "seller-status__filter-option--active" : ""
          }`}
        ...
        <button
          className={`seller-status__filter-option ${
            filter == "waiting" ? "seller-status__filter-option--active" : ""
          }`}
        ...
        <button
          className={`seller-status__filter-option ${
            filter == "delivering" ? "seller-status__filter-option--active" : ""
          }`}
        ...
        <button
          className={`seller-status__filter-option ${
            filter == "success" ? "seller-status__filter-option--active" : ""
          }`}
        ...
        <button
          className={`seller-status__filter-option ${
            filter == "failed" ? "seller-status__filter-option--active" : ""
          }`}
        ...
        <div className="seller-status__item">
          <div className="seller-status__product-info">
            ...
            <div className="seller-status__details">
              ...
              <div className="seller-status__category">
