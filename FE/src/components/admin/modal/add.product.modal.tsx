...
import { Col, Form, Input, InputNumber, Modal, Row, Select, type FormProps, type UploadFile } from "antd"
                ...
                >
                    <Row justify={'space-between'}>
                        ...
                        <Col span={10}>
                            ...
                            >
                                <Select
                                    ...
                                    onChange={(value) => setMappingBrands(brand_options.filter(item => item.category_id == value).map(item => ({ label: item.name, value: item.id.toString() })))}
                                />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            ...
                            >
                                <Select
                                    ...
                                    onChange={(value) => setMappingSeries(serie_options.filter(item => item.brand_id == value).map(item => ({ label: item.name, value: item.id.toString() })))}
                        ...
                        <Col span={8}>
                            ...
                            >
                                <Select options={[{ label: 'Còn bán', value: 'true' }, { label: 'Ngừng bán', value: 'false' }]} />
                            </Form.Item>
                        </Col>
                        <Col span={10}></Col>
                        <Col span={10}>
