...
import { getAllCategoriesAPI, getAllProductsAPI, getBrandsAPI, getSeriesAPI, type IBrand } from "@/services/admin/products/admin.product.api";
...
export const useProductsPage = () => {
    ...
    const loadSelectOptions = async () => {
        try {
            ...
            if (categories.data) {
                setCategoriesList(categories.data.results.map(item => ({ value: item.id.toString(), label: item.name })))
            }
