                                ...
                                <div className="seller-order-detail__product-item">
                                    <div className="seller-order-detail__product-info">
                                        ...
                                        <div className="seller-order-detail__product-details">
                                            <h3 className='seller-order-detail__product-name'>Tên sản phẩm</h3>
                                    ...
                                    <div className="seller-order-detail__product-price">100.000VND</div>
                                </div>
                ...
                <div className="seller-order-detail__card">
                    ...
                    <div className="seller-order-detail__customer-info">
                        <div className="seller-order-detail__info-group">
                            <p><span className="seller-order-detail__info-label">Họ và tên:</span> <span className="seller-order-detail__info-value">Lê Nguyễn Văn Sĩ</span></p>
                            <p><span className="seller-order-detail__info-label">Số điện thoại:</span> <span className="seller-order-detail__info-value">01234567890</span></p>
                        </div>
                        <div className="seller-order-detail__info-group seller-order-detail__info-group--address">
                            <div>
                                ...
                                <div className="seller-order-detail__info-value">Số 123 Đường ABC, Khu phố A, Tỉnh ABC</div>
                            </div>
            ...
            <div className="seller-order-detail__sidebar">
                <div className="seller-order-detail__summary">
                    ...
                    <div className="seller-order-detail__summary-row seller-order-detail__summary-row--final">
                        ...
                        <span className="seller-order-detail__summary-price--final">200.000VND</span>
                    </div>
                </div>
            </div>
        </div>
